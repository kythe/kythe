...
def _cc_dependencies():
    ...
    # Revisions older than LTS 20250127 omit <cstdint> includes and fail to
    # build with clang 19+/gcc 13+.
    maybe(
        http_archive,
    ...
    maybe(
        ...
        # Implements the protobuf ErrorCollector::RecordError API, which
        # replaced AddError. Required by protobuf >= 26.
...
def _go_dependencies():
    ...
    http_archive(
        ...
        # v0.30.0, the version pinned by rules_go 0.61.0 as of 2026-09-14
        urls = [
