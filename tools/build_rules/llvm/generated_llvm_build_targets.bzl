def generated_llvm_build_targets(ctx):
    ...
    ctx.library(ctx, parent = "X86", required_libraries = ["Analysis", "AsmPrinter", "CodeGen", "Core", "MC", "SelectionDAG", "Support", "Target", "X86Desc", "X86Info", "X86Utils", "GlobalISel", "ProfileData", "CFGuard"], add_to_library_groups = ["X86"], name = "X86CodeGen")
    ...
    ctx.tool(ctx, parent = "Tools", required_libraries = ["BitReader", "BitWriter"], name = "llvm-modextract")
