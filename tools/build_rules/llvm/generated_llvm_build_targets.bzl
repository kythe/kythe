def generated_llvm_build_targets(ctx):
    ...
    ctx.library(ctx, parent = "ExecutionEngine", required_libraries = ["MC", "Object", "Support"], name = "RuntimeDyld")
    ...
    ctx.library(ctx, parent = "Sparc", required_libraries = ["Support"], add_to_library_groups = ["Sparc"], name = "SparcInfo")
    ...
    ctx.library(ctx, parent = "VE", required_libraries = ["Analysis", "AsmPrinter", "CodeGen", "Core", "MC", "SelectionDAG", "VEAsmPrinter", "VEDesc", "VEInfo", "Support", "Target"], add_to_library_groups = ["VE"], name = "VECodeGen")
    ctx.library(ctx, add_to_library_groups = ["VE"], name = "VEAsmPrinter", parent = "VE", required_libraries = ["MC", "Support"])
    ctx.library(ctx, parent = "VE", required_libraries = ["MC", "VEAsmPrinter", "VEInfo", "Support"], add_to_library_groups = ["VE"], name = "VEDesc")
    ...
    ctx.tool(ctx, required_libraries = ["BitReader", "BitstreamReader", "Support"], name = "llvm-bcanalyzer", parent = "Tools")
