def generated_llvm_build_targets(ctx):
    ...
    ctx.library(ctx, required_libraries = ["Core", "MC", "Object", "Support"], name = "RuntimeDyld", parent = "ExecutionEngine")
    ...
    ctx.library(ctx, parent = "Libraries", required_libraries = ["Support"], name = "Extensions")
    ...
    ctx.library(ctx, parent = "MC", required_libraries = ["MC", "Support"], name = "MCParser")
    ...
    ctx.library(ctx, required_libraries = ["BinaryFormat", "Object", "Support", "DebugInfoCodeView", "MC"], name = "ObjectYAML", parent = "Libraries")
    ...
    ctx.library(ctx, name = "ProfileData", parent = "Libraries", required_libraries = ["Core", "Support", "Demangle"])
    ...
    ctx.library(ctx, parent = "ARM", required_libraries = ["Support"], add_to_library_groups = ["ARM"], name = "ARMInfo")
    ...
    ctx.library(ctx, required_libraries = ["AsmPrinter", "CodeGen", "Core", "MC", "BPFDesc", "BPFInfo", "IPO", "Scalar", "SelectionDAG", "Support", "Target"], add_to_library_groups = ["BPF"], name = "BPFCodeGen", parent = "BPF")
    ...
    ctx.library(ctx, add_to_library_groups = ["BPF"], name = "BPFDisassembler", parent = "BPF", required_libraries = ["MCDisassembler", "BPFInfo", "Support"])
    ...
    ctx.library(ctx, add_to_library_groups = ["CSKY"], name = "CSKYCodeGen", parent = "CSKY", required_libraries = ["Core", "CodeGen", "CSKYInfo", "Support", "Target"])
    ...
    ctx.library(ctx, required_libraries = ["Analysis", "AsmPrinter", "CodeGen", "Core", "LanaiAsmParser", "LanaiDesc", "LanaiInfo", "MC", "SelectionDAG", "Support", "Target", "TransformUtils"], add_to_library_groups = ["Lanai"], name = "LanaiCodeGen", parent = "Lanai")
    ...
    ctx.library(ctx, parent = "RISCV", required_libraries = ["Support"], add_to_library_groups = ["RISCV"], name = "RISCVInfo")
    ...
    ctx.library(ctx, parent = "Sparc", required_libraries = ["MCDisassembler", "SparcInfo", "Support"], add_to_library_groups = ["Sparc"], name = "SparcDisassembler")
    ...
    ctx.library(ctx, required_libraries = ["Support"], add_to_library_groups = ["VE"], name = "VEInfo", parent = "VE")
    ...
    ctx.library(ctx, parent = "WebAssembly", required_libraries = ["WebAssemblyDesc", "MCDisassembler", "WebAssemblyInfo", "Support", "MC"], add_to_library_groups = ["WebAssembly"], name = "WebAssemblyDisassembler")
    ...
    ctx.library(ctx, required_libraries = ["Analysis", "AsmPrinter", "CodeGen", "Core", "MC", "SelectionDAG", "Support", "Target", "X86Desc", "X86Info", "GlobalISel", "ProfileData", "CFGuard"], add_to_library_groups = ["X86"], name = "X86CodeGen", parent = "X86")
    ...
    ctx.library(ctx, library_name = "HelloNew", required_libraries = ["Core", "Support"], name = "HelloNew", parent = "Transforms")
    ...
    ctx.tool(ctx, parent = "Tools", required_libraries = ["MC", "MCA", "MCParser", "Support", "all-targets"], name = "llvm-mca")
    ...
    ctx.build_tool(ctx, required_libraries = ["Support", "TableGen"], name = "tblgen", parent = "BuildTools")
