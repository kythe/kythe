def generated_llvm_build_targets(ctx):
    ...
    ctx.library(ctx, required_libraries = ["MC", "BPFInfo", "Support"], add_to_library_groups = ["BPF"], name = "BPFDesc", parent = "BPF")
    ...
    ctx.library(ctx, required_libraries = ["Support"], add_to_library_groups = ["Hexagon"], name = "HexagonInfo", parent = "Hexagon")
    ...
    ctx.library(ctx, parent = "X86", required_libraries = ["Support"], add_to_library_groups = ["X86"], name = "X86Utils")
    ...
    ctx.tool(ctx, parent = "Tools", required_libraries = ["MC", "MCDisassembler", "MCParser", "Support", "all-targets"], name = "llvm-mc")
