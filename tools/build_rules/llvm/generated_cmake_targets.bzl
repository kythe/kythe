def generated_cmake_targets(ctx):
    ...
    ctx.add_llvm_component_library(ctx, "LLVMX86Disassembler", "X86Disassembler.cpp", "X86DisassemblerDecoder.cpp")
    ctx = ctx.pop_directory(ctx)
