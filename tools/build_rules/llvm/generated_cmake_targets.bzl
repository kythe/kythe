def generated_cmake_targets(ctx):
    ...
    ctx = ctx.pop_directory(ctx)
    ctx = ctx.push_directory(ctx, "GlobalISel")
    ctx.add_llvm_component_library(ctx, "LLVMGlobalISel", "CSEInfo.cpp", "GISelKnownBits.cpp", "CSEMIRBuilder.cpp", "CallLowering.cpp", "GlobalISel.cpp", "Combiner.cpp", "CombinerHelper.cpp", "GISelChangeObserver.cpp", "IRTranslator.cpp", "InstructionSelect.cpp", "InstructionSelector.cpp", "LegalityPredicates.cpp", "LegalizeMutations.cpp", "Legalizer.cpp", "LegalizerHelper.cpp", "LegalizerInfo.cpp", "Localizer.cpp", "LostDebugLocObserver.cpp", "MachineIRBuilder.cpp", "RegBankSelect.cpp", "RegisterBank.cpp", "RegisterBankInfo.cpp", "Utils.cpp", "DEPENDS", "intrinsics_gen")
    ctx = ctx.pop_directory(ctx)
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMDWARFLinker", "DWARFLinkerCompileUnit.cpp", "DWARFLinkerDeclContext.cpp", "DWARFLinker.cpp", "DWARFStreamer.cpp", "DEPENDS", "intrinsics_gen")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMLTO", "Caching.cpp", "LTO.cpp", "LTOBackend.cpp", "LTOModule.cpp", "LTOCodeGenerator.cpp", "SummaryBasedOptimizations.cpp", "UpdateCompilerUsed.cpp", "ThinLTOCodeGenerator.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/LTO", "ENABLE_PLUGINS", "DEPENDS", "intrinsics_gen", "llvm_vcsrevision_h")
    ctx = ctx.pop_directory(ctx)
