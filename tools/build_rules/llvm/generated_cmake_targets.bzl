def generated_cmake_targets(ctx):
    ...
    ctx = ctx.push_directory(ctx, "IR")
    ctx.add_llvm_component_library(ctx, "LLVMCore", "AbstractCallSite.cpp", "AsmWriter.cpp", "Attributes.cpp", "AutoUpgrade.cpp", "BasicBlock.cpp", "Comdat.cpp", "ConstantFold.cpp", "ConstantRange.cpp", "Constants.cpp", "Core.cpp", "DIBuilder.cpp", "DataLayout.cpp", "DebugInfo.cpp", "DebugInfoMetadata.cpp", "DebugLoc.cpp", "DiagnosticHandler.cpp", "DiagnosticInfo.cpp", "DiagnosticPrinter.cpp", "Dominators.cpp", "FPEnv.cpp", "Function.cpp", "GVMaterializer.cpp", "Globals.cpp", "IRBuilder.cpp", "IRPrintingPasses.cpp", "InlineAsm.cpp", "Instruction.cpp", "Instructions.cpp", "IntrinsicInst.cpp", "KnowledgeRetention.cpp", "LLVMContext.cpp", "LLVMContextImpl.cpp", "LLVMRemarkStreamer.cpp", "LegacyPassManager.cpp", "MDBuilder.cpp", "Mangler.cpp", "Metadata.cpp", "Module.cpp", "ModuleSummaryIndex.cpp", "Operator.cpp", "OptBisect.cpp", "Pass.cpp", "PassInstrumentation.cpp", "PassManager.cpp", "PassRegistry.cpp", "PassTimingInfo.cpp", "SafepointIRVerifier.cpp", "ProfileSummary.cpp", "Statepoint.cpp", "Type.cpp", "TypeFinder.cpp", "Use.cpp", "User.cpp", "Value.cpp", "ValueSymbolTable.cpp", "Verifier.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/IR", "LINK_LIBS", "", "DEPENDS", "intrinsics_gen")
    ctx = ctx.pop_directory(ctx)
