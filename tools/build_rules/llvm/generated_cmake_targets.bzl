def generated_cmake_targets(ctx):
    ...
    ctx.add_llvm_library(ctx, "LLVMDebugInfoGSYM", "FunctionInfo.cpp", "InlineInfo.cpp", "Range.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/DebugInfo/GSYM", "/root/include/llvm/DebugInfo")
    ctx = ctx.pop_directory(ctx)
