def generated_cmake_targets(ctx):
    ...
    ctx.set(ctx, "ENABLE_EXPERIMENTAL_NEW_PASS_MANAGER", "TRUE", "CACHE", "BOOL", "Enable the new pass manager by default.")
    ...
    ctx.set(ctx, "LLVM_ENABLE_NEW_PASS_MANAGER", "TRUE")
    ...
    ctx.tablegen(ctx, "LLVM", "ACC.inc", "--gen-directive-impl")
    ...
    ctx.tablegen(ctx, "LLVM", "OMP.inc", "--gen-directive-impl")
    ...
    ctx = ctx.push_directory(ctx, "IR")
    ctx.add_llvm_component_library(ctx, "LLVMCore", "AbstractCallSite.cpp", "AsmWriter.cpp", "Assumptions.cpp", "Attributes.cpp", "AutoUpgrade.cpp", "BasicBlock.cpp", "BuiltinGCs.cpp", "Comdat.cpp", "ConstantFold.cpp", "ConstantRange.cpp", "Constants.cpp", "Core.cpp", "DIBuilder.cpp", "DataLayout.cpp", "DebugInfo.cpp", "DebugInfoMetadata.cpp", "DebugLoc.cpp", "DiagnosticHandler.cpp", "DiagnosticInfo.cpp", "DiagnosticPrinter.cpp", "Dominators.cpp", "FPEnv.cpp", "Function.cpp", "GCStrategy.cpp", "GVMaterializer.cpp", "Globals.cpp", "IRBuilder.cpp", "IRPrintingPasses.cpp", "InlineAsm.cpp", "Instruction.cpp", "Instructions.cpp", "IntrinsicInst.cpp", "LLVMContext.cpp", "LLVMContextImpl.cpp", "LLVMRemarkStreamer.cpp", "LegacyPassManager.cpp", "MDBuilder.cpp", "Mangler.cpp", "Metadata.cpp", "Module.cpp", "ModuleSummaryIndex.cpp", "Operator.cpp", "OptBisect.cpp", "Pass.cpp", "PassInstrumentation.cpp", "PassManager.cpp", "PassRegistry.cpp", "PassTimingInfo.cpp", "PrintPasses.cpp", "SafepointIRVerifier.cpp", "ProfileSummary.cpp", "PseudoProbe.cpp", "ReplaceConstant.cpp", "Statepoint.cpp", "StructuralHash.cpp", "Type.cpp", "TypeFinder.cpp", "Use.cpp", "User.cpp", "Value.cpp", "ValueSymbolTable.cpp", "Verifier.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/IR", "LINK_LIBS", "", "DEPENDS", "intrinsics_gen", "LINK_COMPONENTS", "BinaryFormat", "Remarks", "Support")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMRemarks", "BitstreamRemarkParser.cpp", "BitstreamRemarkSerializer.cpp", "Remark.cpp", "RemarkFormat.cpp", "RemarkLinker.cpp", "RemarkParser.cpp", "RemarkSerializer.cpp", "RemarkStreamer.cpp", "RemarkStringTable.cpp", "YAMLRemarkParser.cpp", "YAMLRemarkSerializer.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/Remarks", "LINK_COMPONENTS", "BitstreamReader", "Support", "DEPENDS", "intrinsics_gen")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMExecutionEngine", "ExecutionEngine.cpp", "ExecutionEngineBindings.cpp", "GDBRegistrationListener.cpp", "SectionMemoryManager.cpp", "TargetSelect.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/ExecutionEngine", "DEPENDS", "intrinsics_gen", "LINK_COMPONENTS", "Core", "MC", "Object", "OrcTargetProcess", "RuntimeDyld", "Support", "Target")
    ...
    ctx.add_llvm_component_library(ctx, "LLVMOrcTargetProcess", "JITLoaderGDB.cpp", "RegisterEHFrames.cpp", "TargetExecutionUtils.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/ExecutionEngine/Orc", "LINK_COMPONENTS", "OrcShared", "Support")
    ctx = ctx.pop_directory(ctx)
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMTextAPI", "Architecture.cpp", "ArchitectureSet.cpp", "InterfaceFile.cpp", "PackedVersion.cpp", "Platform.cpp", "Symbol.cpp", "Target.cpp", "TextStub.cpp", "TextStubCommon.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/TextAPI", "LINK_COMPONENTS", "Support", "BinaryFormat")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.tablegen(ctx, "LLVM", "AArch64GenO0PreLegalizeGICombiner.inc", "-gen-global-isel-combiner", "-combiners=\"AArch64O0PreLegalizerCombinerHelper\"")
    ...
    ctx.clang_tablegen(ctx, "riscv_vector_builtins.inc", "-gen-riscv-vector-builtins", "SOURCE", "riscv_vector.td", "TARGET", "ClangRISCVVectorBuiltins")
    ctx.clang_tablegen(ctx, "riscv_vector_builtin_cg.inc", "-gen-riscv-vector-builtin-codegen", "SOURCE", "riscv_vector.td", "TARGET", "ClangRISCVVectorBuiltinCG")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_clang_library(ctx, "clangBasic", "Attributes.cpp", "Builtins.cpp", "CharInfo.cpp", "CodeGenOptions.cpp", "Cuda.cpp", "Diagnostic.cpp", "DiagnosticIDs.cpp", "DiagnosticOptions.cpp", "ExpressionTraits.cpp", "FileEntry.cpp", "FileManager.cpp", "FileSystemStatCache.cpp", "IdentifierTable.cpp", "LangOptions.cpp", "LangStandards.cpp", "Module.cpp", "ObjCRuntime.cpp", "OpenCLOptions.cpp", "OpenMPKinds.cpp", "OperatorPrecedence.cpp", "ProfileList.cpp", "NoSanitizeList.cpp", "SanitizerSpecialCaseList.cpp", "Sanitizers.cpp", "SourceLocation.cpp", "SourceManager.cpp", "Stack.cpp", "TargetID.cpp", "TargetInfo.cpp", "Targets.cpp", "Targets/AArch64.cpp", "Targets/AMDGPU.cpp", "Targets/ARC.cpp", "Targets/ARM.cpp", "Targets/AVR.cpp", "Targets/BPF.cpp", "Targets/Hexagon.cpp", "Targets/Lanai.cpp", "Targets/Le64.cpp", "Targets/M68k.cpp", "Targets/MSP430.cpp", "Targets/Mips.cpp", "Targets/NVPTX.cpp", "Targets/OSTargets.cpp", "Targets/PNaCl.cpp", "Targets/PPC.cpp", "Targets/RISCV.cpp", "Targets/SPIR.cpp", "Targets/Sparc.cpp", "Targets/SystemZ.cpp", "Targets/TCE.cpp", "Targets/VE.cpp", "Targets/WebAssembly.cpp", "Targets/X86.cpp", "Targets/XCore.cpp", "TokenKinds.cpp", "TypeTraits.cpp", "Version.cpp", "Warnings.cpp", "XRayInstr.cpp", "XRayLists.cpp", "/root/tools/clang/lib/Basic/VCSVersion.inc", "DEPENDS", "omp_gen")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx = ctx.pop_directory(ctx)
    ctx = ctx.push_directory(ctx, "Sema")
    ctx.set(ctx, "LLVM_LINK_COMPONENTS", "Core", "FrontendOpenMP", "MC", "Support")
    ...
    ctx = ctx.pop_directory(ctx)
    ctx = ctx.push_directory(ctx, "Interpreter")
    ctx.set(ctx, "LLVM_LINK_COMPONENTS", "core", "native", "Option", "OrcJit", "Support", "Target")
    ctx.add_clang_library(ctx, "clangInterpreter", "IncrementalExecutor.cpp", "IncrementalParser.cpp", "Interpreter.cpp", "LINK_LIBS", "clangAST", "clangAnalysis", "clangBasic", "clangDriver", "clangEdit", "clangFrontend", "clangLex", "clangParse", "clangSema", "clangSerialization", "clangCodeGen", "clangFrontendTool")
    ctx = ctx.pop_directory(ctx)
    ctx = ctx.pop_directory(ctx)
    ...
    ctx = ctx.pop_directory(ctx)
    ctx = ctx.push_directory(ctx, "clang-repl")
    ctx.set(ctx, "LLVM_LINK_COMPONENTS", "all", "Core", "Option", "OrcJIT", "Support")
    ctx = ctx.pop_directory(ctx)
