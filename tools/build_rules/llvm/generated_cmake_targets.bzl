def generated_cmake_targets(ctx):
    ...
    ctx.add_llvm_library(ctx, "LLVMRemarks", "BitstreamRemarkSerializer.cpp", "Remark.cpp", "RemarkFormat.cpp", "RemarkParser.cpp", "RemarkSerializer.cpp", "RemarkStringTable.cpp", "YAMLRemarkParser.cpp", "YAMLRemarkSerializer.cpp")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_library(ctx, "LLVMDebugInfoGSYM", "FileWriter.cpp", "FunctionInfo.cpp", "InlineInfo.cpp", "Range.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/DebugInfo/GSYM", "/root/include/llvm/DebugInfo")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_library(ctx, "LLVMJITLink", "JITLink.cpp", "JITLinkGeneric.cpp", "JITLinkMemoryManager.cpp", "EHFrameSupport.cpp", "MachO.cpp", "MachO_x86_64.cpp", "MachOAtomGraphBuilder.cpp", "DEPENDS", "intrinsics_gen")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_clang_library(ctx, "clangDependencyScanning", "DependencyScanningFilesystem.cpp", "DependencyScanningService.cpp", "DependencyScanningWorker.cpp", "DEPENDS", "ClangDriverOptions", "LINK_LIBS", "clangAST", "clangBasic", "clangDriver", "clangFrontend", "clangFrontendTool", "clangLex", "clangParse", "clangSerialization", "clangTooling")
    ctx = ctx.pop_directory(ctx)
