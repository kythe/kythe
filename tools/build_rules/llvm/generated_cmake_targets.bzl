def generated_cmake_targets(ctx):
    ...
    ctx.add_llvm_component_library(ctx, "LLVMInterfaceStub", "ELFObjHandler.cpp", "ELFStub.cpp", "TBEHandler.cpp")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMFrontendOpenMP", "OMP.cpp", "OMPContext.cpp", "OMPIRBuilder.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/Frontend", "/root/include/llvm/Frontend/OpenMP", "DEPENDS", "intrinsics_gen", "omp_gen", "omp_cpp")
    ctx = ctx.pop_directory(ctx)
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMHelloNew", "HelloWorld.cpp", "DEPENDS", "intrinsics_gen")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMCoroutines", "Coroutines.cpp", "CoroCleanup.cpp", "CoroEarly.cpp", "CoroElide.cpp", "CoroFrame.cpp", "CoroSplit.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/Transforms/Coroutines", "DEPENDS", "intrinsics_gen", "LLVMAnalysis")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMObjectYAML", "CodeViewYAMLDebugSections.cpp", "CodeViewYAMLSymbols.cpp", "CodeViewYAMLTypeHashing.cpp", "CodeViewYAMLTypes.cpp", "COFFEmitter.cpp", "COFFYAML.cpp", "DWARFEmitter.cpp", "DWARFYAML.cpp", "ELFEmitter.cpp", "ELFYAML.cpp", "MachOEmitter.cpp", "MachOYAML.cpp", "ObjectYAML.cpp", "MinidumpEmitter.cpp", "MinidumpYAML.cpp", "WasmEmitter.cpp", "WasmYAML.cpp", "XCOFFYAML.cpp", "YAML.cpp", "yaml2obj.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/ObjectYAML")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMTextAPI", "MachO/Architecture.cpp", "MachO/ArchitectureSet.cpp", "MachO/InterfaceFile.cpp", "MachO/PackedVersion.cpp", "MachO/Platform.cpp", "MachO/Symbol.cpp", "MachO/Target.cpp", "MachO/TextStub.cpp", "MachO/TextStubCommon.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/TextAPI", "/root/include/llvm/TextAPI/Elf", "/root/include/llvm/TextAPI/MachO")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMWindowsManifest", "WindowsManifestMerger.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/WindowsManifest", "", "LINK_LIBS", "")
    ctx = ctx.pop_directory(ctx)
    ctx = ctx.pop_directory(ctx)
    ctx = ctx.pop_directory(ctx)
