def generated_cmake_targets(ctx):
    ...
    ctx.tablegen(ctx, "LLVM", "ACC.cpp.inc", "--gen-directive-gen")
    ...
    ctx.tablegen(ctx, "LLVM", "OMP.cpp.inc", "--gen-directive-gen")
    ...
    ctx.add_llvm_component_library(ctx, "LLVMAsmPrinter", "AccelTable.cpp", "AddressPool.cpp", "AIXException.cpp", "ARMException.cpp", "AsmPrinter.cpp", "AsmPrinterDwarf.cpp", "AsmPrinterInlineAsm.cpp", "DbgEntityHistoryCalculator.cpp", "DebugHandlerBase.cpp", "DebugLocStream.cpp", "DIE.cpp", "DIEHash.cpp", "DwarfCFIException.cpp", "DwarfCompileUnit.cpp", "DwarfDebug.cpp", "DwarfExpression.cpp", "DwarfFile.cpp", "DwarfStringPool.cpp", "DwarfUnit.cpp", "EHStreamer.cpp", "ErlangGCPrinter.cpp", "OcamlGCPrinter.cpp", "WinCFGuard.cpp", "WinException.cpp", "CodeViewDebug.cpp", "WasmException.cpp", "DEPENDS", "intrinsics_gen", "LINK_COMPONENTS", "Analysis", "BinaryFormat", "CodeGen", "Core", "DebugInfoCodeView", "DebugInfoDWARF", "DebugInfoMSF", "MC", "MCParser", "Remarks", "Support", "Target")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMDWARFLinker", "DWARFLinkerCompileUnit.cpp", "DWARFLinkerDeclContext.cpp", "DWARFLinker.cpp", "DWARFStreamer.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/DWARFLinker", "DEPENDS", "intrinsics_gen", "LINK_COMPONENTS", "DebugInfoDWARF", "AsmPrinter", "CodeGen", "MC", "Object", "Support")
    ctx = ctx.pop_directory(ctx)
    ...
    ctx.add_llvm_component_library(ctx, "LLVMOrcShared", "OrcError.cpp", "RPCError.cpp", "TargetProcessControlTypes.cpp", "ADDITIONAL_HEADER_DIRS", "/root/include/llvm/ExecutionEngine/Orc", "LINK_COMPONENTS", "Support")
    ctx = ctx.pop_directory(ctx)
