...
lint_copyright() {
  case $file in
    third_party/*|*.md|CAMPFIRE|BUILD|*/BUILD|.campfire_settings|buildtools/*|*/testdata/*|*.yaml|*.json|*.html|*.pb.go|.arclint|.gitignore|*/.gitignore|.arcconfig|*/__phutil_*|*.bzl|.kythe)
