...
_BAZEL_TO_CONFIG_SPEC_NAMES = {"1.2.0": ["default_toolchain_config_spec_name"], "2.1.0": ["default_toolchain_config_spec_name"], "2.1.1": ["default_toolchain_config_spec_name"], "2.2.0": ["default_toolchain_config_spec_name"]}
