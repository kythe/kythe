...
_BAZEL_TO_CONFIG_SPEC_NAMES = {"3.6.0": ["default_toolchain_config_spec_name"], "3.7.0": ["default_toolchain_config_spec_name"], "3.7.2": ["default_toolchain_config_spec_name"]}
