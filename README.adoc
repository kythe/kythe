...
./campfire build //kythe/java/com/google/devtools/kythe/analyzers/java:indexer
./campfire-out/bin/kythe/java/com/google/devtools/kythe/analyzers/java/indexer
...
xdg-open campfire-out/gen/kythe/docs/schema/schema.html
----
