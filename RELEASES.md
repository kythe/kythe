...
* **build:**
  *  add generic kzip_archive rule (#3876) ([70a843a8](https://github.com/kythe/kythe/commit/70a843a809d0bf81278eeb9a994096f9ef7eb279))
  *  switch to using targets generated by kythe/llvmbzlgen (#3837) ([5397106f](https://github.com/kythe/kythe/commit/5397106f716e15fa1ee0c6b75d49b8ca435b541d))
* **cxx_common:**
...
* **bazel:**
  *  proto toolchain not guaranteed to support no_enforce_api_compatibility (#3693) ([12524aca](https://github.com/kythe/kythe/commit/12524aca167402992b601d04a4621017773c0246))
  *  include jsr250 jar for java extraction (#3647) ([f8dc4355](https://github.com/kythe/kythe/commit/f8dc43552164190f90ae00dfb687515b10243856))
  *  add curses to always-installed packages in the Bazel dockerfile (#3642) ([2fe11a64](https://github.com/kythe/kythe/commit/2fe11a640861bf666f99c267e4c26bf27d2c6602))
  *  Extraction exits with nonzero error code if unable to create kzip (#3629) ([2c553016](https://github.com/kythe/kythe/commit/2c5530168eea3977d1300db57fa458f50f6aad16))
* **build:**
  *  include C++14 options in default build flags (#4008) ([39d1ccbb](https://github.com/kythe/kythe/commit/39d1ccbbdd99a7a92a370676f6e8bdf912c53b1c), closes [#4006](https://github.com/kythe/kythe/issues/4006))
  *  fully qualify workspace references in lexyacc rules (#3656) ([2f05e066](https://github.com/kythe/kythe/commit/2f05e066e21f2d4d055aadd34e790b36334e72c8))
  *  remove duplicate src paths in java_extract_kzip (#3530) ([252c0466](https://github.com/kythe/kythe/commit/252c046619c21ce621ed049697cef3813bfb0276))
* **compdb_test:**  ignore log files instead of treating as kzip (#3697) ([cdde2ae5](https://github.com/kythe/kythe/commit/cdde2ae52db523444ccdb632a4eef9dbc83195e2))
* **cxx:**
  ...
  *  remove dependency on ncurses/terminfo (#3644) ([dfeaa897](https://github.com/kythe/kythe/commit/dfeaa897b79b28fa38a8603890abe3fe6af39a60))
* **cxx_common:**
...
* **dev:**
  *  format shasum_tool output to match sha256sum (#3573) ([611d903a](https://github.com/kythe/kythe/commit/611d903a6a88b0acddf2875e84efd54b91d10c7e))
  *  include brotli and leveldb in the macOS package list (#3519) ([48264e2b](https://github.com/kythe/kythe/commit/48264e2bd9ad29ec31ec300acd19920868b99267))
  *  allow specification of a correct Bison version (#3516) ([a3f8334f](https://github.com/kythe/kythe/commit/a3f8334f75d605cfb037c31b17584fa6aa693edb))
  *  use POSIX safe flags for tr (#3515) ([9dbb2a1a](https://github.com/kythe/kythe/commit/9dbb2a1ab7a6b7668d81effa543659f4be8bf11b))
* **docs:**
  *  clarify variable subkinds and aliases edge (#3979) ([5a75161f](https://github.com/kythe/kythe/commit/5a75161f1e93f323b85f091c23daadc56745bdda))
  *  update kzip doc for proto encoding and unit naming (#3954) ([87fac8cf](https://github.com/kythe/kythe/commit/87fac8cfa15a7bd6ff49cb9d7e008d884cce199b))
  *  NodeKind.getSubkind returns Optional. (#3626) ([df9cc99e](https://github.com/kythe/kythe/commit/df9cc99e015da302f41d0b135a81c1cdd661c118))
  *  update release docs to specify kzip (#3618) ([5192f831](https://github.com/kythe/kythe/commit/5192f831574bdfde26c21c414343abb8ea70c45a))
  *  update getting started for clang-3.6 (#3576) ([39b7473c](https://github.com/kythe/kythe/commit/39b7473cfb7d2fd925c00debe5c68edb241f309d))
  *  clarify VName documentation in analysis.proto (#3560) ([44c348b3](https://github.com/kythe/kythe/commit/44c348b344ac3fea7ef4e3e53b645f424c11a796))
* **extraction:**
  *  update bazel-extractor Docker image to clang-6.0 (#4066) ([58f6250f](https://github.com/kythe/kythe/commit/58f6250f93df187418eac6bfeee970c02d844dc8))
...
* **go extractor:**  fix invalid Details messages for packages (#4120) ([426a9b0b](https://github.com/kythe/kythe/commit/426a9b0be61ff6eb35a9bc94fdd4e73d79e28138))
...
* **guava:**  allow using guava along with modules (#3559) ([78c92cb2](https://github.com/kythe/kythe/commit/78c92cb21d460072c6915d93f94e27867f93eeee))
* **java:**
...
* **java_common:**
  ...
  *  cufs shares FileDataProvider and should not close it (#4103) ([0692beab](https://github.com/kythe/kythe/commit/0692beab05f74f201c9f3112d1df0b3bf34f626b))
  *  mark CompilationUnitFileSystem public (#3977) ([2d72afe9](https://github.com/kythe/kythe/commit/2d72afe9170521f62a08cbb907018d000a60394a))
...
* **java_extractor:**
  ...
  *  change an iterable to a collection (#3620) ([0daf616c](https://github.com/kythe/kythe/commit/0daf616c191abcc788a12b1915d8e8e45ba2cce7))
  *  move JDK9 method reflection to static members (#3616) ([f4373076](https://github.com/kythe/kythe/commit/f4373076d655944e6f0853e96f775461e81e46cb))
  ...
  *  initial work enabling extraction of openjdk11 (#3607) ([3ad566cd](https://github.com/kythe/kythe/commit/3ad566cd3cf258c38a2d72062d30be26932d9092))
* **java_indexer:**
...
* **javac-wrapper:**  use `set -e` to propagate errors (#4042) ([f37f1c90](https://github.com/kythe/kythe/commit/f37f1c90e1e1a6182edcb595f62362f631a8a0ea))
...
* **kzip info:**  determine unit corpus and file language more robustly (#4095) ([c4a354e8](https://github.com/kythe/kythe/commit/c4a354e835acef2b9eb14d026142f440b5871fd0))
* **kzip_create:**  implement flag.Getter for all flat types (#3544) ([a47b32ed](https://github.com/kythe/kythe/commit/a47b32ed1f6a747a0606cad38ac30340386a056a))
* **leiningen:**
  *  ensure wrapper script uses /bin/bash rather than /bin/sh (#3640) ([a6479446](https://github.com/kythe/kythe/commit/a647944696a6dad6eac98f18049ab95a3a3de50d))
  *  fail lein setup w/ incompatible JDK (#3638) ([99d6c67c](https://github.com/kythe/kythe/commit/99d6c67cb6c49aebd0e248f1d619794678deb5f4))
...
* **textproto:**
  ...
  *  less log spam (#47) ([371e7e3a](https://github.com/kythe/kythe/commit/371e7e3aeb0fb6ce983815bd095fb6a353040dba))
...
* **typescript_indexer:**
  ...
  *  reduce TODOs for less logs (#3866) ([fd06e232](https://github.com/kythe/kythe/commit/fd06e232f65fc4d8a9848914aa9e3ad7be1f3a90))
...
* **vname_util:**  add missing #includes (#12) ([d2ff3cc5](https://github.com/kythe/kythe/commit/d2ff3cc57acf7ecf2ed5f41b028a46ee768de92b))
