...
-   `<analysis-type>`: an identifier for a specific type or types of analyses.
...
-   `analyze(AnalyzeRequest) → AnalyzeReply`
    ...
    The reply includes the "root" file on which to begin analysis, as well as
    the output file to which to emit output. The driver (and driver environment)
    ...
    Example:
        ...
        » {"jsonrpc":"2.0","id":2,"method":"analyze","params":{"type":"kythe/indexer/go"}}
...
» {"jsonrpc":"2.0", "id":2, "method":"analysis", "params":{"type":"kythe/indexer/go"}}
« {"jsonrpc":"2.0", "id":2, "result":{"id":101, "unit":{...1...}}}
» {"jsonrpc":"2.0", "id":3, "method":"analysis", "params":{"type":"kythe/indexer/go"}}
