...
func (*Document) Descriptor() ([]byte, []int) { return fileDescriptorServing, []int{13} }
...
func (*IdentifierMatch) Descriptor() ([]byte, []int) { return fileDescriptorServing, []int{14} }
...
func (*IdentifierMatch_Node) Descriptor() ([]byte, []int) { return fileDescriptorServing, []int{14, 0} }
...
func (m *Document) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MarkedSource != nil {
		...
		i++
		i = encodeVarintServing(dAtA, i, uint64(m.MarkedSource.Size()))
		n19, err := m.MarkedSource.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
	...
	if len(m.RawText) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintServing(dAtA, i, uint64(len(m.RawText)))
	...
	if len(m.ChildTicket) > 0 {
		for _, s := range m.ChildTicket {
			dAtA[i] = 0x2a
			i++
			l = len(s)
			for l >= 1<<7 {
	...
	if len(m.DocumentedBy) > 0 {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintServing(dAtA, i, uint64(len(m.DocumentedBy)))
		i += copy(dAtA[i:], m.DocumentedBy)
	}
	return i, nil
}

func (m *IdentifierMatch) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *IdentifierMatch) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.QualifiedName) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintServing(dAtA, i, uint64(len(m.QualifiedName)))
		i += copy(dAtA[i:], m.QualifiedName)
	}
	if len(m.BaseName) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintServing(dAtA, i, uint64(len(m.BaseName)))
...
func (m *IdentifierMatch_Node) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *IdentifierMatch_Node) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.NodeKind) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintServing(dAtA, i, uint64(len(m.NodeKind)))
		i += copy(dAtA[i:], m.NodeKind)
	}
	if len(m.NodeSubkind) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintServing(dAtA, i, uint64(len(m.NodeSubkind)))
...
func (m *IdentifierMatch) Size() (n int) {
	var l int
	_ = l
...
func (m *IdentifierMatch_Node) Size() (n int) {
	var l int
	_ = l
	l = len(m.Ticket)
	if l > 0 {
...
func (m *Document) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChildTicket", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ChildTicket = append(m.ChildTicket, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Node", wireType)
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DocumentedBy", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DocumentedBy = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipServing(dAtA[iNdEx:])
...
func (m *IdentifierMatch) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 3:
			...
			m.Node = append(m.Node, &IdentifierMatch_Node{})
			if err := m.Node[len(m.Node)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *IdentifierMatch_Node) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
var fileDescriptorServing = []byte{
	...
	,
}
