...
/*
Package link_go_proto is a generated protocol buffer package.
...
func (*LinkRequest_Location) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
func (*LinkRequest_Params) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 1} }
...
type Link struct {
	...
	Span       *kythe_proto_common.Span `protobuf:"bytes,2,opt,name=span" json:"span,omitempty"`
...
func (m *Link) GetSpan() *kythe_proto_common.Span {
	if m != nil {
		return m.Span
	}
	return nil
...
func (*Link_Node) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1, 0} }
...
func (*LinkReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func init() { proto.RegisterFile("kythe/proto/link.proto", fileDescriptor0) }
