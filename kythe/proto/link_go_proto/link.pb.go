...
const file_kythe_proto_link_proto_rawDesc = "" +
	"\n" +
	"\x16kythe/proto/link.proto\x12\vkythe.proto\x1a\x18kythe/proto/common.proto\"\xc6\x04\n" +
	"\vLinkRequest\x12\x1e\n" +
	"\n" +
	"identifier\x18\x01 \x01(\tR\n" +
	"identifier\x12\x16\n" +
	"\x06corpus\x18\x02 \x03(\tR\x06corpus\x12\x1a\n" +
	"\blanguage\x18\x03 \x03(\tR\blanguage\x12\x1b\n" +
	"\tnode_kind\x18\x04 \x03(\tR\bnodeKind\x12;\n" +
	"\ainclude\x18\x05 \x03(\v2!.kythe.proto.LinkRequest.LocationR\ainclude\x12;\n" +
	"\aexclude\x18\x06 \x03(\v2!.kythe.proto.LinkRequest.LocationR\aexclude\x127\n" +
	"\x06params\x18\a \x01(\v2\x1f.kythe.proto.LinkRequest.ParamsR\x06params\x12P\n" +
	"\x0fdefinition_kind\x18\b \x01(\x0e2'.kythe.proto.LinkRequest.DefinitionKindR\x0edefinitionKind\x12#\n" +
	"\rinclude_nodes\x18\t \x01(\bR\fincludeNodes\x1aJ\n" +
	"\bLocation\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x12\n" +
	"\x04root\x18\x02 \x01(\tR\x04root\x12\x16\n" +
	"\x06corpus\x18\x03 \x01(\tR\x06corpus\x1a\x1e\n" +
	"\x06Params\x12\x14\n" +
	"\x05count\x18\x01 \x01(\x05R\x05count\"0\n" +
	"\x0eDefinitionKind\x12\v\n" +
	"\aBINDING\x10\x00\x12\b\n" +
	"\x04FULL\x10\x01\x12\a\n" +
	"\x03ANY\x10\x02\"\xe0\x01\n" +
	"\x04Link\x12\x1f\n" +
	"\vfile_ticket\x18\x01 \x01(\tR\n" +
	"fileTicket\x12,\n" +
	"\x04span\x18\x02 \x01(\v2\x18.kythe.proto.common.SpanR\x04span\x12,\n" +
	"\x05nodes\x18\x03 \x03(\v2\x16.kythe.proto.Link.NodeR\x05nodes\x1a[\n" +
	"\x04Node\x12\x16\n" +
	"\x06ticket\x18\x01 \x01(\tR\x06ticket\x12\x1b\n" +
	"\tbase_name\x18\x02 \x01(\tR\bbaseName\x12\x1e\n" +
	"\n" +
	"identifier\x18\x03 \x01(\tR\n" +
	"identifier\"4\n" +
	"\tLinkReply\x12'\n" +
	"\x05links\x18\x01 \x03(\v2\x11.kythe.proto.LinkR\x05links2L\n" +
	"\vLinkService\x12=\n" +
	"\aResolve\x12\x18.kythe.proto.LinkRequest\x1a\x16.kythe.proto.LinkReply\"\x00BE\n" +
	"\x1fcom.google.devtools.kythe.protoZ\"kythe.io/kythe/proto/link_go_protob\x06proto3"

var (
	file_kythe_proto_link_proto_rawDescOnce sync.Once
	file_kythe_proto_link_proto_rawDescData []byte
)

func file_kythe_proto_link_proto_rawDescGZIP() []byte {
	file_kythe_proto_link_proto_rawDescOnce.Do(func() {
		file_kythe_proto_link_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_kythe_proto_link_proto_rawDesc), len(file_kythe_proto_link_proto_rawDesc)))
	})
...
var file_kythe_proto_link_proto_goTypes = []any{
...
func file_kythe_proto_link_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kythe_proto_link_proto_rawDesc), len(file_kythe_proto_link_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
