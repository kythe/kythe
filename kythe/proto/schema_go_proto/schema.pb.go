...
func (NodeKind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_schema_8034c99943647345, []int{0}
}
...
func (Subkind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_schema_8034c99943647345, []int{1}
}
...
func (FactName) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_schema_8034c99943647345, []int{2}
}
...
func (EdgeKind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_schema_8034c99943647345, []int{3}
}
...
func (*Index_EdgeKinds) Descriptor() ([]byte, []int) {
	return fileDescriptor_schema_8034c99943647345, []int{0, 0}
}
...
func (*Index_NodeKinds) Descriptor() ([]byte, []int) {
	return fileDescriptor_schema_8034c99943647345, []int{0, 1}
}
...
func (*Index_Subkinds) Descriptor() ([]byte, []int) {
	return fileDescriptor_schema_8034c99943647345, []int{0, 2}
}
...
func (*Index_FactNames) Descriptor() ([]byte, []int) {
	return fileDescriptor_schema_8034c99943647345, []int{0, 3}
}
...
func init() { proto.RegisterFile("kythe/proto/schema.proto", fileDescriptor_schema_8034c99943647345) }

var fileDescriptor_schema_8034c99943647345 = []byte{
	...
	,
}
