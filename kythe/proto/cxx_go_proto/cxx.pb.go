...
/*
Package cxx_go_proto is a generated protocol buffer package.
...
func (*CxxCompilationUnitDetails) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func init() { proto.RegisterFile("kythe/proto/cxx.proto", fileDescriptor0) }
