...
type CrossReferencesRequest struct {
	...
	Filter []string `protobuf:"bytes,5,rep,name=filter" json:"filter,omitempty"`
	// Determines which kinds of RelatedNodes should be returned in the response.
	// If empty, all known RelatedNodes will be returned that match the above
	// filter.  Otherwise, only RelatedNodes with one of these requested kinds,
	// and matching the above filter, will be returned in the response.
...
func (m *CrossReferencesRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RelatedNodeKind) > 0 {
		for _, s := range m.RelatedNodeKind {
			dAtA[i] = 0x72
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *CrossReferencesRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RelatedNodeKind", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RelatedNodeKind = append(m.RelatedNodeKind, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 100:
			if wireType != 0 {
...
var fileDescriptorXref = []byte{
	...
	,
}
