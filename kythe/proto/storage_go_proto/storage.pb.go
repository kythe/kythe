...
const file_kythe_proto_storage_proto_rawDesc = "" +
	"\n" +
	"\x19kythe/proto/storage.proto\x12\vkythe.proto\"\x81\x01\n" +
	"\x05VName\x12\x1c\n" +
	"\tsignature\x18\x01 \x01(\tR\tsignature\x12\x16\n" +
	"\x06corpus\x18\x02 \x01(\tR\x06corpus\x12\x12\n" +
	"\x04root\x18\x03 \x01(\tR\x04root\x12\x12\n" +
	"\x04path\x18\x04 \x01(\tR\x04path\x12\x1a\n" +
	"\blanguage\x18\x05 \x01(\tR\blanguage\"\x85\x01\n" +
	"\tVNameMask\x12\x1c\n" +
	"\tsignature\x18\x01 \x01(\bR\tsignature\x12\x16\n" +
	"\x06corpus\x18\x02 \x01(\bR\x06corpus\x12\x12\n" +
	"\x04root\x18\x03 \x01(\bR\x04root\x12\x12\n" +
	"\x04path\x18\x04 \x01(\bR\x04path\x12\x1a\n" +
	"\blanguage\x18\x05 \x01(\bR\blanguage\"\xb8\x01\n" +
	"\x05Entry\x12*\n" +
	"\x06source\x18\x01 \x01(\v2\x12.kythe.proto.VNameR\x06source\x12\x1b\n" +
	"\tedge_kind\x18\x02 \x01(\tR\bedgeKind\x12*\n" +
	"\x06target\x18\x03 \x01(\v2\x12.kythe.proto.VNameR\x06target\x12\x1b\n" +
	"\tfact_name\x18\x04 \x01(\tR\bfactName\x12\x1d\n" +
	"\n" +
	"fact_value\x18\x05 \x01(\fR\tfactValue\"7\n" +
	"\aEntries\x12,\n" +
	"\aentries\x18\x01 \x03(\v2\x12.kythe.proto.EntryR\aentries\"V\n" +
	"\vReadRequest\x12*\n" +
	"\x06source\x18\x01 \x01(\v2\x12.kythe.proto.VNameR\x06source\x12\x1b\n" +
	"\tedge_kind\x18\x02 \x01(\tR\bedgeKind\"\x84\x02\n" +
	"\fWriteRequest\x12*\n" +
	"\x06source\x18\x01 \x01(\v2\x12.kythe.proto.VNameR\x06source\x128\n" +
	"\x06update\x18\x02 \x03(\v2 .kythe.proto.WriteRequest.UpdateR\x06update\x1a\x8d\x01\n" +
	"\x06Update\x12\x1b\n" +
	"\tedge_kind\x18\x01 \x01(\tR\bedgeKind\x12*\n" +
	"\x06target\x18\x02 \x01(\v2\x12.kythe.proto.VNameR\x06target\x12\x1b\n" +
	"\tfact_name\x18\x03 \x01(\tR\bfactName\x12\x1d\n" +
	"\n" +
	"fact_value\x18\x04 \x01(\fR\tfactValue\"\f\n" +
	"\n" +
	"WriteReply\"w\n" +
	"\vScanRequest\x12*\n" +
	"\x06target\x18\x01 \x01(\v2\x12.kythe.proto.VNameR\x06target\x12\x1b\n" +
	"\tedge_kind\x18\x02 \x01(\tR\bedgeKind\x12\x1f\n" +
	"\vfact_prefix\x18\x03 \x01(\tR\n" +
	"factPrefix\"<\n" +
	"\fCountRequest\x12\x14\n" +
	"\x05index\x18\x01 \x01(\x03R\x05index\x12\x16\n" +
	"\x06shards\x18\x02 \x01(\x03R\x06shards\"&\n" +
	"\n" +
	"CountReply\x12\x18\n" +
	"\aentries\x18\x01 \x01(\x03R\aentries\"<\n" +
	"\fShardRequest\x12\x14\n" +
	"\x05index\x18\x01 \x01(\x03R\x05index\x12\x16\n" +
	"\x06shards\x18\x02 \x01(\x03R\x06shards\"W\n" +
	"\x10VNameRewriteRule\x12\x18\n" +
	"\apattern\x18\x01 \x01(\tR\apattern\x12)\n" +
	"\x06v_name\x18\x02 \x01(\v2\x12.kythe.proto.VNameR\x05vname\"F\n" +
	"\x11VNameRewriteRules\x121\n" +
	"\x04rule\x18\x01 \x03(\v2\x1d.kythe.proto.VNameRewriteRuleR\x04ruleBH\n" +
	"\x1fcom.google.devtools.kythe.protoZ%kythe.io/kythe/proto/storage_go_protob\x06proto3"

var (
	file_kythe_proto_storage_proto_rawDescOnce sync.Once
	file_kythe_proto_storage_proto_rawDescData []byte
)

func file_kythe_proto_storage_proto_rawDescGZIP() []byte {
	file_kythe_proto_storage_proto_rawDescOnce.Do(func() {
		file_kythe_proto_storage_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_kythe_proto_storage_proto_rawDesc), len(file_kythe_proto_storage_proto_rawDesc)))
	})
...
var file_kythe_proto_storage_proto_goTypes = []any{
...
func file_kythe_proto_storage_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kythe_proto_storage_proto_rawDesc), len(file_kythe_proto_storage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
