...
import _ "kythe.io/kythe/proto/filecontext_go_proto"
...
func (AnalysisResult_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{2, 0}
}
...
func (*AnalysisRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{0}
}
...
func (*AnalysisOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{1}
}
...
func (*AnalysisResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{2}
}
...
func (*CompilationUnit) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{3}
}
...
func (*CompilationUnit_FileInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{3, 0}
}
...
func (*CompilationUnit_Env) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{3, 1}
}
...
func (*FilesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{4}
}
...
func (*FileInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{5}
}
...
func (*FileData) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{6}
}
...
func (*CompilationBundle) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{7}
}
...
func (*IndexedCompilation) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{8}
}
...
func (*IndexedCompilation_Index) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_1fa85e5658fb244a, []int{8, 0}
}
...
func init() {
	proto.RegisterFile("kythe/proto/analysis.proto", fileDescriptor_analysis_1fa85e5658fb244a)
}

var fileDescriptor_analysis_1fa85e5658fb244a = []byte{
	// 839 bytes of a gzipped FileDescriptorProto
	,
}
