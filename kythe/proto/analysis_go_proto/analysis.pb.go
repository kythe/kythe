...
func (AnalysisResult_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_analysis_d40526f820602bca, []int{2, 0}
}
...
func (*AnalysisRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_d40526f820602bca, []int{0}
}
...
func (*AnalysisOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_d40526f820602bca, []int{1}
}
...
func (*AnalysisResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_d40526f820602bca, []int{2}
}
...
func (*CompilationUnit) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_d40526f820602bca, []int{3}
}
...
func (*CompilationUnit_FileInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_d40526f820602bca, []int{3, 0}
}
...
func (*CompilationUnit_Env) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_d40526f820602bca, []int{3, 1}
}
...
func (*FilesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_d40526f820602bca, []int{4}
}
...
func (*FileInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_d40526f820602bca, []int{5}
}
...
func (*FileData) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_d40526f820602bca, []int{6}
}
...
func (*CompilationBundle) Descriptor() ([]byte, []int) {
	return fileDescriptor_analysis_d40526f820602bca, []int{7}
}
...
func init() {
	proto.RegisterFile("kythe/proto/analysis.proto", fileDescriptor_analysis_d40526f820602bca)
}

var fileDescriptor_analysis_d40526f820602bca = []byte{
	// 813 bytes of a gzipped FileDescriptorProto
	,
}
