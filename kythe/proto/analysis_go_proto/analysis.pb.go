...
type KzipInfo_CorpusInfo struct {
	...
	SourceFiles          map[string]int32 `protobuf:"bytes,3,rep,name=source_files,json=sourceFiles,proto3" json:"source_files,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	RequiredInputFiles   map[string]int32 `protobuf:"bytes,4,rep,name=required_input_files,json=requiredInputFiles,proto3" json:"required_input_files,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *KzipInfo_CorpusInfo) GetSourceFiles() map[string]int32 {
	if m != nil {
...
func (m *KzipInfo_CorpusInfo) GetRequiredInputFiles() map[string]int32 {
	if m != nil {
		return m.RequiredInputFiles
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[string]int32)(nil), "kythe.proto.KzipInfo.CorpusInfo.RequiredInputFilesEntry")
	proto.RegisterMapType((map[string]int32)(nil), "kythe.proto.KzipInfo.CorpusInfo.SourceFilesEntry")
...
var fileDescriptor_8e4ea7eca60afe48 = []byte{
	...
	,
}
