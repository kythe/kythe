...
func (m *KzipInfo_Count) Reset()         { *m = KzipInfo_Count{} }
func (m *KzipInfo_Count) String() string { return proto.CompactTextString(m) }
func (*KzipInfo_Count) ProtoMessage()    {}
func (*KzipInfo_Count) Descriptor() ([]byte, []int) {
	return fileDescriptor_8e4ea7eca60afe48, []int{4, 0}
}

func (m *KzipInfo_Count) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_KzipInfo_Count.Unmarshal(m, b)
}
func (m *KzipInfo_Count) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_KzipInfo_Count.Marshal(b, m, deterministic)
}
func (m *KzipInfo_Count) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KzipInfo_Count.Merge(m, src)
}
func (m *KzipInfo_Count) XXX_Size() int {
	return xxx_messageInfo_KzipInfo_Count.Size(m)
}
func (m *KzipInfo_Count) XXX_DiscardUnknown() {
	xxx_messageInfo_KzipInfo_Count.DiscardUnknown(m)
}

var xxx_messageInfo_KzipInfo_Count proto.InternalMessageInfo

func (m *KzipInfo_Count) GetLanguage() string {
	if m != nil {
		return m.Language
	}
	return ""
...
func (m *KzipInfo_Count) GetCount() int32 {
	if m != nil {
		return m.Count
	}
	return 0
...
func (*KzipInfo_CorpusInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8e4ea7eca60afe48, []int{4, 1}
}
...
func init() {
	...
	proto.RegisterType((*KzipInfo_Count)(nil), "kythe.proto.KzipInfo.Count")
