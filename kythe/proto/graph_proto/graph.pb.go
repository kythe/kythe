...
/*
Package graph_go_proto is a generated protocol buffer package.
...
func (*NodesRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
type NodesReply struct {
	Nodes map[string]*kythe_proto_common.NodeInfo `protobuf:"bytes,1,rep,name=nodes" json:"nodes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*NodesReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*EdgesRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*EdgeSet) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*EdgeSet_Group) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3, 0} }
...
func (*EdgeSet_Group_Edge) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3, 0, 0} }
...
func (*EdgesReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func init() { proto.RegisterFile("kythe/proto/graph.proto", fileDescriptor0) }
