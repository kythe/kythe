...
void KytheGraphObserver::recordDenotesEdge(const NodeId& denoter_id,
                                           const NodeId& denotee_id) {
  recorder_->AddEdge(VNameRefFromNodeId(denoter_id), EdgeKindID::kDenotes,
