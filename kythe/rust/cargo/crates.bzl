...
def raze_fetch_remote_crates():
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:adler-0.2.3.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:aho-corasick-0.7.13.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:ansi_term-0.11.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:anyhow-1.0.32.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:assert_cmd-1.0.1.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:atty-0.2.14.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:autocfg-1.0.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:bitflags-1.2.1.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:byteorder-1.3.4.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:bzip2-0.3.3.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:bzip2-sys-0.1.9+1.0.8.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:cc-1.0.58.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:cfg-if-0.1.10.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:clap-2.33.1.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:colored-2.0.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:crc32fast-1.2.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:derive-new-0.5.8.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:difference-2.0.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:doc-comment-0.3.3.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:either-1.5.3.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:flate2-1.0.16.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:float-cmp-0.8.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:fst-0.3.5.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:fuchsia-cprng-0.1.1.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:gcc-0.3.55.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:hermit-abi-0.1.15.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:itertools-0.8.2.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:itoa-0.4.6.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:json-0.11.15.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:lazy_static-1.4.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:libc-0.2.74.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:log-0.4.11.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:miniz_oxide-0.4.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:normalize-line-endings-0.3.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:pkg-config-0.3.18.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:podio-0.1.7.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:predicates-1.0.5.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:predicates-core-1.0.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:predicates-tree-1.0.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:proc-macro2-1.0.19.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:protobuf-2.8.2.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:quick-error-1.2.3.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:quote-1.0.7.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:rand-0.3.23.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:rand-0.4.6.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:rand_core-0.3.1.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:rdrand-0.4.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:regex-1.3.9.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:regex-syntax-0.6.18.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:remove_dir_all-0.5.3.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:rls-analysis-0.18.1.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:rls-data-0.19.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:rls-span-0.5.2.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:rust-crypto-0.2.36.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:rustc-serialize-0.3.24.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:ryu-1.0.5.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:serde-1.0.114.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:strsim-0.8.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:syn-1.0.36.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:tempdir-0.3.7.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:textwrap-0.11.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:thread_local-1.0.1.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:time-0.1.43.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:treeline-0.1.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:unicode-width-0.1.8.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:unicode-xid-0.2.1.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:vec_map-0.8.2.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:wait-timeout-0.2.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:winapi-0.3.9.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:winapi-i686-pc-windows-gnu-0.4.0.BUILD"),
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//kythe/rust/cargo/remote:winapi-x86_64-pc-windows-gnu-0.4.0.BUILD"),
    )
